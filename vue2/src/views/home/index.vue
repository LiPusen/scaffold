<template>
  <section class="content">
    <swiper class="my-swipe" :options="swiperOption">
      <swiper-slide class="silde" v-for="(billboard, index) in billboards">
          <v-img-load :src='billboard.imageUrl' placeholder="http://static.m.maizuo.com/v4/static/app/asset/3d2cdb3bd9a23609aa2d84e7c2bfd035.png"></v-img-load>
      </swiper-slide>
    </swiper>
    <div class="movie">
...
<script>
  ...
  export default{
    ...
    components: {
      NowPlaying, ComingSoon, swiper, swiperSlide
    }
  }
</script>
